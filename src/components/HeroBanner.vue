...
export default {
  ...
  computed: {
    bgStyle() {
      const img = this.bgImage || 'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?auto=format&fit=crop&w=1400&q=60'
      return {
        backgroundImage: `linear-gradient(180deg, rgba(0,87,184,0.92), rgba(0,71,141,0.92)), url(${img})`,
